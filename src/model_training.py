...
MODEL_NAME = "gpt2"
MAX_LENGTH = 256  # Keep reasonable length for quality
...
class MemoryOptimizedTrainer(Trainer):
    ...
    def log(self, *args, **kwargs):
        """Override logging to add memory cleanup - handles any signature"""
...
def main():
    ...
    training_args = TrainingArguments(
        ...
        num_train_epochs=7,  # Reasonable number of epochs
